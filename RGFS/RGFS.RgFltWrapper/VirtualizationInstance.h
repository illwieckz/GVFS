...
namespace RgLib 
{
    ...
    public:
        ...
        /// <summary>Starts a RgFlt virtualization instance</summary>
        ...
        /// for a path from OnGetPlaceholderInformation callback, RgFlt will remember 
        ...
        ///
        /// If RgFlt filter driver is not loaded, PrivilegeNotHeld is returned.  
        ///
        ...
        ///
        /// StartVirtualizationInstance function starts a RgFlt virtualization instance by performing below actions:
        /// 
        ///     1) Attaches the RgFlt driver to the volume that contains the virtualization root
        ///     2) Establishes two comm ports to the driver
        ///     3) Registers the callback routine that handles commands from RgFlt
        /// 
        /// If RgFlt filter is already attached to the volume, this function can be called from a non-elevated process.
        ...
        /// <summary>Detaches RgFlt driver from the volume</summary>
        ...
        /// <summary>Send file stream data to the RgFlt driver in a OnGetFileStream callback</summary>
        ...
        ///
        /// If WriteFile or RgFlt filter fails to allocate memory, InsufficientResources is returned.
        ///
        /// If WriteFile fails to send the message to RgFlt filter, InternalError is returned.
        ///    see also - https://msdn.microsoft.com/en-us/library/windows/hardware/ff541513(v=vs.85).aspx
        ///
        /// If RgFlt responses the message with a unexpected message type, InternalError is returned.
        ///
        /// If RgFlt filter fails to write to the file, the NtStatus error from file system will be returned.
        ...
        /// 
        /// For all allowed updateFlags values, if the file is a “Virtual File”, RgFlt will not be able to open a handle to it
        ///     and hence the file system error ObjectNameNotFound would be returned.
        /// 
        /// If the function or RgFlt filter fails to allocate memory, InsufficientResources is returned.
        /// 
        /// If the function fails to send the message to RgFlt filter, InternalError is returned.
        ///     See also - https://msdn.microsoft.com/en-us/library/windows/hardware/ff541513(v=vs.85).aspx
        /// 
        /// If RgFlt responds to the message with a unexpected message type, InternalError is returned.
        /// 
        /// If RgFlt cannot open the file, the NtStatus error from the file system will be returned.
        /// 
        /// For any delete related operation, NtStatus error from the file system will be returned.
        /// </returns>
        /// <remarks>
        /// Based on the value of updateFlags, RgFlt behaves in the following manner :
        /// For a file in state :
        /// 
        /// 1. Placeholder / Partial:
        ///     If metadata is not dirty, RgFlt will always attempt deleting the file
        ...
        /// 
        ///     Based on the sets of bits set, RgFlt will provide the functionality.  The provider
        ...
        /// <summary>Sends file or directory metadata to the RgFlt driver in a GetPlaceholderInformation callback</summary>
        ...
        ///
        /// If WritePlaceholderInformation or RgFlt filter fails to allocate memory, InsufficientResources is returned.
        /// 
        /// If WritePlaceholderInformation fails to send the message to RgFlt filter, InternalError is returned.
        ///     see also - https://msdn.microsoft.com/en-us/library/windows/hardware/ff541513(v=vs.85).aspx
        /// 
        /// If RgFlt responds to the message with a unexpected message type, InternalError is returned.
        /// 
        /// If RgFlt filter fails to create the new file, the NtStatus error from file system will be returned.
        ...
        ///
        /// If CreatePlaceholderAsHardlink or RgFlt filter fails to allocate memory, InsufficientResources is returned.
        /// 
        /// If CreatePlaceholderAsHardlink fails to send the message to RgFlt filter, InternalError is returned.
        ///     see also - https://msdn.microsoft.com/en-us/library/windows/hardware/ff541513(v=vs.85).aspx
        /// 
        /// If RgFlt responds to the message with a unexpected message type, InternalError is returned.
        /// 
        /// If RgFlt filter fails to create the hard link, the NtStatus error from file system will be returned.
        ///     see also - https://msdn.microsoft.com/en-us/library/windows/hardware/ff541939(v=vs.85).aspx
        ///</returns>
        /// <remarks>
        ...
        /// 
        /// For all allowed UpdateFlags values, if the file is a “Virtual File”, RgFlt will not be able to open
        ...
        /// </returns>
        /// <remarks>
        /// Based on the value of the flags, RgFlt would behave in the following manner-
        /// 
        /// For a file in state :
        /// 
        /// 1. Placeholder / Partial :
        ///     If metadata is not dirty, RgFlt will always attempt Updating the file
        ///     irrespective of the flags set in updateFlags.
        /// 
        ...
        /// <remarks>
        /// CompleteCommand is used to notify RgFlt that an asynchronous operation has completed.  When a
        /// callback returns NtStatus::Pending, RgFlt will hold the request that triggered the callback
        ...
        /// <summary>Converts an existing folder to a RgFlt virtualization root</summary>
