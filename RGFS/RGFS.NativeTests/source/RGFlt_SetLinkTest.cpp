...
static const std::string TEST_ROOT_FOLDER("\\RGFlt_SetLinkTest");
static const std::string _testFile("test.txt");
static const std::string _data("test data");

bool RGFlt_SetLink_ToVirtualFile(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_ToPlaceHolder(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_ToFullFile(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_ToNonExistFileWillFail(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_NameAlreadyExistWillFail(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_FromOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_SetLink_ToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
