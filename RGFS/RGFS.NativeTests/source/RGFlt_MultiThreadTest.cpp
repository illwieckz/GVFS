#include "stdafx.h"
#include "RGFlt_MultiThreadsTest.h"
...
static const std::string TEST_ROOT_FOLDER("\\RGFLT_MultiThreadTest");
...
bool RGFlt_OpenForReadsSameTime(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_OpenMultipleFilesForReadsSameTime(const char* virtualRootPath)
{
    try
    {
        ...
        {
            // Files are named:
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime\test1
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime\test2
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime\test3
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime\test4
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime_2\test5
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime_2\test6
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime_2\test7
            // RGFlt_MultiThreadTest\OpenMultipleFilesForReadsSameTime_2\test8
...
bool RGFlt_OpenForWritesSameTime(const char* virtualRootPath)
{
    try
    {
