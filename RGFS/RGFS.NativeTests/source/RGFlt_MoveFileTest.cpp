...
static const std::string TEST_ROOT_FOLDER("\\RGFlt_MoveFileTest");
static const std::string _lessData = "lessData";
static const std::string _moreData = "moreData, moreData, moreData";

bool RGFlt_MoveFile_NoneToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_PartialToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_FullToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_LocalToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToVirtual(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToVirtualFileNameChanged(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToPartial(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_PartialToPartial(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_LocalToVirtual(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToVirtualIntermidiateDirNotExist(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToNoneIntermidiateDirNotExist(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_OutsideToNone(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_OutsideToVirtual(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_OutsideToPartial(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_NoneToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_VirtualToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_PartialToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_OutsideToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFile_LongFileName(const char* virtualRootPath)
{
    try
    {
