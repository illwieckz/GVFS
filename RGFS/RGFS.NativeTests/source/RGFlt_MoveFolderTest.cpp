#include "stdafx.h"
#include "RGFlt_MoveFolderTest.h"
...
static const std::string TEST_ROOT_FOLDER("\\RGFlt_MoveFolderTest");

bool RGFlt_MoveFolder_NoneToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_VirtualToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_PartialToNone(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_VirtualToVirtual(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_VirtualToPartial(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_OutsideToNone(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_OutsideToVirtual(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_NoneToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_VirtualToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_MoveFolder_OutsideToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
