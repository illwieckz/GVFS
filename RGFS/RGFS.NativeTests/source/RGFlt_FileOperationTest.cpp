#include "stdafx.h"
#include "RGFlt_FileOperationTest.h"
...
static const std::string TEST_ROOT_FOLDER("\\RGFlt_FileOperationTest");

bool RGFlt_OpenRootFolder(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_WriteAndVerify(const char* virtualRootPath)
{
    try
    {
...
bool RGFlt_DeleteExistingFile(const char* virtualRootPath)
{
    try
    {
        std::string scratchRoot = virtualRootPath + TEST_ROOT_FOLDER + "\\";
...
bool RGFlt_OpenNonExistingFile(const char* virtualRootPath)
{
    try
    {
        std::string scratchRoot = virtualRootPath + TEST_ROOT_FOLDER + "\\";
