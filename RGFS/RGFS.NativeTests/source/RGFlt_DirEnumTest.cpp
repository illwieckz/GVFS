...
static const std::string TEST_ROOT_FOLDER("\\RGFlt_EnumTest");

bool RGFlt_EnumEmptyFolder(const char* virtualRootPath)
{
    try
    {
        std::string folderPath = virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumEmptyFolder\\");
...
bool RGFlt_EnumFolderWithOneFileInPackage(const char* virtualRootPath)
{
    try
    {
        std::vector<FileInfo> result = EnumDirectory(virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumFolderWithOneFileInPackage\\"));
...
bool RGFlt_EnumFolderWithOneFileInBoth(const char* virtualRootPath)
{
    try
    {
        std::string existingFileName = "newfileInPackage.txt";
        std::string newFileName = "newfileInScratch.txt";
        std::string folderPath = virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumFolderWithOneFileInBoth\\");
...
bool RGFlt_EnumFolderWithOneFileInBoth1(const char* virtualRootPath)
{
    try
    {
        std::string existingFileName = "newfileInPackage.txt";
        std::string newFileName = "123";
        std::string folderPath = virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumFolderWithOneFileInBoth1\\");
        CreateNewFile(folderPath + newFileName);
...
bool RGFlt_EnumFolderDeleteExistingFile(const char* virtualRootPath)
{
    try
    {
        std::string fileName1 = "fileInPackage1.txt";
        std::string fileName2 = "fileInPackage2.txt";
        std::string folderPath = virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumFolderDeleteExistingFile\\");
...
bool RGFlt_EnumFolderSmallBuffer(const char* virtualRootPath)
{
    std::string folderPath = virtualRootPath + TEST_ROOT_FOLDER + std::string("\\RGFlt_EnumFolderSmallBuffer");
