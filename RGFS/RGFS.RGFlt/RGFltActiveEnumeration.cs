...
{
    public class RGFltActiveEnumeration : IDisposable
    {
        private readonly IEnumerable<RGFltFileInfo> fileInfos;
        private IEnumerator<RGFltFileInfo> fileInfoEnumerator;
        private bool disposed = false;
        private string filterString = null;

        public RGFltActiveEnumeration(IEnumerable<RGFltFileInfo> fileInfos)
        {
        ...
        /// </summary>
        public RGFltFileInfo Current
        {
            get { return this.fileInfoEnumerator.Current; }
        }

        /// <summary>
        /// Resets the enumerator and advances it to the first RGFltFileInfo in the enumeration
        /// </summary>
